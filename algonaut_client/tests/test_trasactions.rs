...
use algonaut_transaction::ConfigureAsset;
...
fn test_create_asset_transaction() -> Result<(), Box<dyn Error>> {
    ...
    let from_address: Address =
        "R2NEPOAJJITVI4P5BAP72KVK6QGJF4RTXESHHT7E5FFBHYMRAY3IKN2ZZY".parse()?;
